...
def throughput_test_once(
    ...
    num_reqs = len(reqs)
    folder = f"/workspace/Super_MARIO/bench_runtime/parallel_value_prompts{num_reqs}_in{test_config['random_input_len']}_out{test_config['random_output_len']}_mem{test_config['mem_fraction_static']}_model{test_config['model_name']}"
